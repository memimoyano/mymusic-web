        ...
        {props.isVisible &&
            <div className="fixed z-20 left-0 top-0 w-screen h-screen overflow-auto bg-neutral-900 bg-opacity-75">
                <div className="mx-auto inset-0 w-full lg:w-11/12 lg:my-28 lg:p-2 2xl:w-7/12 ">
                    <div className="flex flex-row justify-between bg-light-night p-4 lg:rounded-t-lg w-full">
                        <span className="text-lg font-medium  text-ivory tracking-wide ">{props.label}</span>
